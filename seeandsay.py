...
counts as a string like "one 1, two two's" and so forth.  Counts
for each line of input are printed on each line of output.

Such strings of digits can be generated by randomstrings.py.
